...
.data ; Data segment
inp1 db 'Malavika Ramesh' ; Define a byte array 'inp1' containing the input string 'MyName'
colmstr dw ? ; Define a word 'colmstr' to store the column position of the next character
cnt db 15 ; Define a byte 'cnt' containing the length of the input string 
...
.startup ; Executable code starts here
    ...
    MOV CH, 00h
    MOV CL, [DI]
    MOV colmstr, 15 ; Set initial column position to 15
    LEA DI, colmstr
